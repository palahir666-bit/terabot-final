...
async def handle_link(update, context):
    ...
    # Auto-delete after 2 minutes using asyncio
    asyncio.create_task(delete_video_after_delay(update.effective_chat.id, sent_msg.message_id, context.bot))
    await msg.edit_text("✅ Video aa gayi! ⏳ 2 minute ka time hai.")

# ---------- Delete Video ----------
async def delete_video_after_delay(chat_id, message_id, bot):
    await asyncio.sleep(120)  # 2 minute
